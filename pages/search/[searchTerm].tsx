  ...
  return (
    <div className="w-full">
      <div className="flex gap-10 mt-10 mb-10 border-b-2 border-gray-200 bg-white w-full relative">
        <p
          className={`text-xl font-semibold cursor-pointer mt-2 ${accounts} absolute -top-9`}
          onClick={() => setIsAccounts(true)}
        >
          Accounts
        </p>
        <p
          className={`text-xl font-semibold cursor-pointer mt-2 ${isVideos} absolute -top-9 left-28`}
